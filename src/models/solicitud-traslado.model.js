...
export default {
    ...
    getAll: async () => {
        try {
            ...
            const result = await pool.request()
                .query('SELECT * FROM solicitud_traslado');
            return result.recordset || [];
        } catch (error) {
            console.error('Error al obtener solicitudes de traslado:', error.message);
            throw error;
        }
    },
    ...
    getById: async (id) => {
        try {
            ...
            const result = await pool.request()
                ...
                .query('SELECT * FROM solicitud_traslado WHERE id = @id');
            return result.recordset[0] || null;
        } catch (error) {
            console.error(`Error al obtener solicitud de traslado con ID ${id}:`, error.message);
            throw error;
        }
    },
     ...
     * @param {string} año - Año escolar (formato: YYYY)
     * @returns {Promise<Array>} Lista de solicitudes
     */
    getByAño: async (anio) => {
        try {
            ...
            const result = await pool.request()
                ...
                .query('SELECT * FROM solicitud_traslado WHERE anio_escolar = @anio');
            return result.recordset || [];
        } catch (error) {
            console.error(`Error al obtener solicitudes de traslado del año ${anio}:`, error.message);
            throw error;
        }
    },
    ...
    getByDniEstudiante: async (dni) => {
        try {
            ...
            const result = await pool.request()
                ...
                .query('SELECT * FROM solicitud_traslado WHERE dni_estudiante = @dni');
            return result.recordset || [];
        } catch (error) {
            console.error(`Error al obtener solicitudes de traslado con DNI ${dni}:`, error.message);
            throw error;
        }
    },
    ...
    create: async (solicitud) => {
        try {
            ...
            request.input('colegio_anterior', mssql.VarChar(100), solicitud.colegio_anterior);
            request.input('motivo_traslado', mssql.VarChar(200), solicitud.motivo_traslado || null);
            ...
            const sql = `INSERT INTO solicitud_traslado (
            ...
            console.error('Error al crear solicitud de traslado:', error.message);
            throw error;
        }
    },
    ...
    update: async (id, solicitud) => {
        try {
            ...
            let sql = 'UPDATE solicitud_traslado SET ';
            const updateFields = [];
            ...
            if (solicitud.colegio_anterior !== undefined) {
                request.input('colegio_anterior', mssql.VarChar(100), solicitud.colegio_anterior);
                updateFields.push('colegio_anterior = @colegio_anterior');
            }
            if (solicitud.motivo_traslado !== undefined) {
                request.input('motivo_traslado', mssql.VarChar(200), solicitud.motivo_traslado);
                updateFields.push('motivo_traslado = @motivo_traslado');
            }
            ...
            console.error(`Error al actualizar solicitud de traslado con ID ${id}:`, error.message);
            throw error;
        }
    },
    ...
    delete: async (id) => {
        try {
            ...
            const result = await pool.request()
                .input('id', mssql.Int, id)
                .query('DELETE FROM solicitud_traslado WHERE id = @id');
            return { affectedRows: result.rowsAffected[0] };
        } catch (error) {
            console.error(`Error al eliminar solicitud de traslado con ID ${id}:`, error.message);
            throw error;
        }
    }
};
